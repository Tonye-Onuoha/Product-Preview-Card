...
This is a simple HTML and CSS project in which the main objective is to build out a Product-Preview-Card web page.
...
and broke down the styling of elements one piece at a time. Finally, I proceeded to write the media queries for both the
